...
* Consume LLM-powered backends and middle tiers with ease, either synchronously or by streaming
...
To get started with the AI Chat Protocol, check out our getting started guide (coming soon once we are published on npm).
